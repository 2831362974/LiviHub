...
CREATE TABLE `tb_commodity_category`  (
                                          `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
                                          `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分类名称，如"主食"、"饮品"',
                                          PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT '通用商品分类表' ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for tb_commodity
-- ----------------------------
INSERT INTO `tb_commodity_category` (`name`) VALUES
                                                 ('主食'), ('饮品'), ('小吃'), ('套餐'),         -- 美食类基础分类
                                                 ('啤酒'), ('洋酒'), ('鸡尾酒'), ('软饮'),       -- 酒吧类分类
                                                 ('小包厢'), ('中包厢'), ('大包厢'), ('豪华包厢'), -- KTV类分类
                                                 ('洗剪吹'), ('烫染套餐'), ('护理'), ('造型'),     -- 美发类分类
                                                 ('足疗'), ('按摩'), ('SPA'), ('采耳'),          -- 养生类分类
                                                 ('亲子套餐'), ('儿童游乐'), ('手工DIY'),          -- 亲子类分类
                                                 ('代金券'), ('体验券'), ('折扣券');             -- 通用券类分类
DROP TABLE IF EXISTS `tb_commodity`;
CREATE TABLE `tb_commodity`  (
                                 `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
                                 `shop_id` bigint(20) UNSIGNED NOT NULL COMMENT '所属商铺id，关联tb_shop表',
                                 `category_id` bigint(20) UNSIGNED NULL DEFAULT NULL COMMENT '商品分类id，关联tb_commodity_category表',
                                 ...
                                 `original_price` bigint(10) UNSIGNED NOT NULL COMMENT '原价，单位：分',
                                 `current_price` bigint(10) UNSIGNED NOT NULL COMMENT '现价，单位：分',
                                 `stock` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '库存数量',
                                 `status` tinyint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '状态：1-上架，2-下架，3-售罄',
                                 `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                 `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                 PRIMARY KEY (`id`) USING BTREE,
